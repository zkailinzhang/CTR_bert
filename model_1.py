...
class Model_1(Model_Base):
    ...
    def __init__(self, model, data_iter, handle,
        ...
        super(Model_1, self).__init__(model, data_iter, handle, prepare_data,
                                      train_data_cate,
...
if __name__ == '__main__':
    ...
    model = Model_1(inner_model, data_iter,
                    handle, prepare_data,
                    train_data_cate,
                    )
    model.run({"batch_size": 128}, ["ubuntu@10.19.90.95:/data/midas-model",
