...
def get_max_model_index(cnt: int = 1):
    model_path = "tmp-model-3/modeldsin_s30/model/"
    if cnt != 1:
        model_path = "update-model-1/modeldsin_s30/model/"
...
def get_max_serving_index(cnt: int = 1):
    model_path = "tmp-model-3/modeldsin_s30/serving/"
    if cnt != 1:
        model_path = "update-model-1/modeldsin_s30/serving/"
...
if __name__ == "__main__":
    ...
    model_path = "update-model-1/modeldsin_s30/model/ckpt_"
    best_model_path = "update-model-1/modeldsin_s30/best-model/ckpt_"

    path1 ='update-model-1/modeldsin_s30'
